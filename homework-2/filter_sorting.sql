...
SELECT AVG(shipped_date - order_date) as avg_days_shipping FROM orders
...
SELECT MIN(unit_price) as min_unit_price, MAX(unit_price) as max_unit_price FROM products
